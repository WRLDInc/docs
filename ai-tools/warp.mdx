...
- **analysis-artifacts** — Generate reproducible SQL queries, Python visualizations, and summary tables for BigQuery deep dives
- **dbt-model-index** — Lookup index of dbt models to guide query writing in a dbt-powered data warehouse
