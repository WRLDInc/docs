...
- **analysis-artifacts** — Scaffold reproducible analysis artifacts (SQL queries, Python visualizations, and summary tables) for BigQuery data deep-dives
- **dbt-model-index** — Maintain a lookup index of dbt models to guide BigQuery SQL query writing against your data warehouse
