...
- **analysis-artifacts** — Generate reproducible SQL queries, Python visualizations, and summary tables during BigQuery data analysis deep dives
- **dbt-model-index** — Customizable lookup index of dbt models to guide query writing against a dbt-powered data warehouse
