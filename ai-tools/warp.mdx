...
- **analysis-artifacts** — Generate reproducible analysis artifacts (SQL queries, Python visualizations, and summary tables) during BigQuery data deep dives
- **ci-fix** — Diagnose and fix CI pipeline failures
- **create-pull-request** — Generate well-structured pull requests from code changes
- **dbt-model-index** — Maintain a customizable lookup index of dbt models to guide query writing against a dbt-powered data warehouse
