...
- **analysis-artifacts** — Generate reproducible analysis artifacts (SQL queries, Python visualizations, and summary tables) for BigQuery data analysis
- **dbt-model-index** — Provide a curated lookup index of dbt models (BigQuery tables) to guide query writing against a data warehouse
