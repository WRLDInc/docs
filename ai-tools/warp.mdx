...
- **analysis-artifacts** — Generate reproducible analysis artifacts (SQL queries, Python visualizations, summary tables) during BigQuery deep dives
- **ci-fix** — Diagnose and fix CI pipeline failures
- **create-pull-request** — Generate well-structured pull requests from code changes
- **dbt-model-index** — Provide a customizable lookup index of dbt models to guide query writing against a data warehouse
