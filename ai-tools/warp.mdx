...
- **analysis-artifacts** — Generate reproducible SQL queries, Python visualizations, and summary tables during BigQuery deep dive analyses
- **dbt-model-index** — Provide a lookup index of dbt models to guide query writing against a dbt-powered data warehouse
