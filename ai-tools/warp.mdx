...
WRLD maintains a catalog of reusable skills in the [oz-skills](https://github.com/warpdotdev/oz-skills) repository. To use one:
...
- **analysis-artifacts** — Generate reproducible SQL queries, Python visualizations, and summary tables during BigQuery data analyses
- **ci-fix** — Diagnose and fix CI pipeline failures
- **create-pull-request** — Generate well-structured pull requests from code changes
- **dbt-model-index** — Customizable lookup index of dbt models to guide query writing against a data warehouse
