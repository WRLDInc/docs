...
<Card title="Sign In to Client Portal" icon="log-in" href="https://wrld.syncromsp.com/portal">
  Open the WRLD Syncro portal to sign in with your email address — no password required.
</Card>
