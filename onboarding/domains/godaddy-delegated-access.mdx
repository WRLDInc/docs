...
Contact [helpdesk@wrld.tech](mailto:helpdesk@wrld.tech), [submit a ticket](/support/submit-ticket), or use the [hosting portal](https://wrld.host/submitticket.php) if you need assistance with the delegation process.
