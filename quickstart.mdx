...
<Steps>
  <Step title="Reach out">
    Email [helpdesk@wrld.tech](mailto:helpdesk@wrld.tech) or [open a ticket](/support/submit-ticket). Include your company name, the service you are interested in, and any relevant context.
  </Step>
  <Step title="Onboard">
