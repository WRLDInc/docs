...
<CardGroup cols={2}>
  <Card icon="server" href="/wrld-host/overview" title="WRLD.host">
    Explore hosting services and get started with your infrastructure.
  </Card>
  <Card icon="robot" href="/wrld-ai/overview" title="WRLD.ai">
    Discover AI-powered solutions for your business.
  </Card>
  <Card icon="ticket" href="/support/submit-ticket" title="Submit a Ticket">
    Start a new support request or look up an existing ticket.
  </Card>
  <Card icon="circle-question" href="/support/overview" title="Support">
    Browse support channels and get help.
  </Card>
</CardGroup>

<Note>
  **Need help?** Email us at [helpdesk@wrld.tech](mailto:helpdesk@wrld.tech) or call [+1 (469) 850-3968](tel:+14698503968).
</Note>
