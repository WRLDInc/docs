...
<CardGroup cols={2}>
  ...
  <Card title="I need support" icon="life-buoy" href="/support/overview">
  ...
  <Card title="I'm exploring WRLD.AI" icon="bot" href="/wrld-ai/overview">
...
<AccordionGroup>
  <Accordion icon="mail" title="Email">
  ...
  <Accordion icon="monitor" title="Remote support">
...
<CardGroup cols={2}>
  ...
  <Card title="AI Tools" icon="wand-sparkles" href="/ai-tools/claude-code">
    Guides for Claude Code, Cursor, Warp, and Windsurf.
  </Card>
  <Card title="Infrastructure" icon="network" href="/infrastructure">
